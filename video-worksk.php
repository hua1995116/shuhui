...
?>
    <div class="bodyz">
         ...
         <?php
          //取出作品资源
          $i=0;
          $_result = _query("SELECT * FROM fruit WHERE type='楷书' AND admin='1' ORDER BY time DESC LIMIT 5");
             ...
             <div class="box1">
                    ...
                    <div class="boxbottom">
                         <div class="boxbottom_left">
                            <a href="othermember?id=<?php echo  $_result_video['id'];?>"><?php echo $_workehtml['onwer'];?></a>
                         </div>
                         <?php if(isset($_COOKIE['username'])){?>
                          <div class="collect"> 
                                <?php
