...
if($_GET['action']=='judge'){
	_query("UPDATE fruit SET admin = '1' WHERE name='{$_POST['name']}' LIMIT 1");
	if(_affect_row()==1){
		_close();
		//跳转
		_location('已同意', 'admin.php');}	
}
...
<div class="result-wrap">
            <form name="myform" id="myform" method="post" action="admin.php?action=judge">
        ...
        <?php 
            $_result=_query("SELECT * FROM fruit WHERE admin='0'");
        ...
        ?> 
             ...
             <tr>
                            ...
                            <td>
								                    ...
								                    <input type="submit" value="同意" id="judgement" />								                  
               ...
               <?php $_allnum=mysql_num_rows(mysql_query("SELECT * FROM fruit WHERE admin='0'"));?>
